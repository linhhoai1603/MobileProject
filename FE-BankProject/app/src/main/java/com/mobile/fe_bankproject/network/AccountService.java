...
public interface AccountService {
    ...
    Call<ImageUploadResponse> uploadAvatar(@Path("accountNumber") String accountNumber, @Part MultipartBody.Part file);

    @Multipart
    @POST("account/background/{accountNumber}")
    Call<ImageUploadResponse> uploadBackground(@Path("accountNumber") String accountNumber, @Part MultipartBody.Part file);
}